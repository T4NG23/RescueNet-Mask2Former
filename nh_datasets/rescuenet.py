...
@register_dataset("rescuenet_mask2former")
class RescueNetMask2FormerDataset(Dataset):
    ...
    def __init__(
        ...
        for fname in os.listdir(self.img_dir):
            ...
            for ext2 in self.IMG_EXTS:
                # FIX: Add the '_lab' suffix to match the label filenames
...
class RescueNetSegDataset(Dataset):
    ...
    Expects pairs like:
        ...
        val/val-label-img/6336_lab.png  <-- Updated expected name
    """
    IMG_EXTS = {".jpg", ".jpeg", ".JPG", ".JPEG", ".png", ".PNG"}
    CLASSES = [
        "Background",
